...
parties('Austria')
graph('Austria','Austrian Freedom Party',10000) #(1)
graph('Austria','Austrian People’s Party',10000) #(1)
...
graph('Bosnia-Herzegovina','Alliance of Independent Social Democrats',1000) #(1)
graph('Bosnia-Herzegovina','Serbian Democratic Party',1000) #(1)
...
#denmark: could be an example of party becoming established after becoming anti-globalist (2) and established becoming anti-globalist (1)
graph('Denmark','Danish People’s Party',10000) #(2)
graph('Denmark','Liberals',10000) #(1)
graph('Denmark','Social Democratic Party',10000) #(1)
#estonia
graph('Estonia',"Conservative People's Party of Estonia",1000)
  ```
